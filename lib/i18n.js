...
export const translations = {
  en: {
    ...
    "sidebar.coffeeBeans": "Coffee Beans",
    "sidebar.dripBag": "Drip Bag",
    "sidebar.coldBrew": "Cold Brew Bag",
    "sidebar.coffeeTools": "Coffee Tools",
    "sidebar.huskee": "Huskee",
    "sidebar.specialOffer": "Special Offer",
    "sidebar.monthlySub": "Monthly Subscription",
    "sidebar.sofeCredits": "Sofe Credits",
    // Cart
    ...
    "subscription.subtitle": "Coffee Beans & Drip Bags",
    "subscription.desc": "Subscribe and save on your favorite coffee",
    "subscription.dripBag": "Coffee Drip Bag",
    "subscription.beans": "Pour Over Coffee Beans",
    "subscription.choose": "Choose Options",
    "subscription.perks": "Enjoy fresh coffee delivered regularly. Cancel anytime.",
    // About
    "about.title": "About SOFE COFFEE",
    "about.visitStores": "Visit Our Stores",
    // Locations
    "locations.title": "Locations",
    "locations.visitUs": "Visit Our Stores",
    // Contact
  ...
  zh: {
    ...
    "sidebar.title": "全部分类",
    "sidebar.home": "首页",
    "sidebar.newArrival": "新品上架",
    "sidebar.coffeeBeans": "咖啡豆",
    "sidebar.dripBag": "挂耳包",
    "sidebar.coldBrew": "冷萃咖啡包",
    "sidebar.coffeeTools": "咖啡器具",
    "sidebar.huskee": "Huskee",
    "sidebar.specialOffer": "特别优惠",
    "sidebar.monthlySub": "月度订阅",
    "sidebar.sofeCredits": "Sofe 储值",
    // Cart
    "cart.title": "购物车",
    "cart.empty": "您的购物车是空的。",
    ...
    // Subscription
    "subscription.title": "月度订阅",
    "subscription.subtitle": "咖啡豆与挂耳包",
    "subscription.desc": "订阅您最爱的咖啡，享受优惠",
    "subscription.dripBag": "咖啡挂耳包",
    "subscription.beans": "手冲咖啡豆",
    "subscription.choose": "选择方案",
    "subscription.perks": "定期享用新鲜咖啡，随时可取消。",
    // About
    "about.title": "关于 SOFE COFFEE",
    "about.visitStores": "前往门店",
    // Locations
    "locations.title": "门店位置",
    "locations.visitUs": "前往门店",
    // Contact
    "contact.title": "联系我们",
  },
}
